            ...
            <form action="" class="mt-12 pl-2 mb-24">
                <div class="md:w-1/2">
                    ...
                    <div class="flex w-full flex-wrap gap-2 mt-2 mb-4">
                        <div class="my-2">
                            @include('components.field.input-text', ['label' => 'components.field.label', 'title' => 'Jam', 'type' => 'time', 'min' => now()->timezone('Asia/Jakarta')->addHours(2)->format('H:i')])
                        </div>
                        <div class="my-2">
                            @include('components.field.input-text', ['label' => 'components.field.label', 'title' => 'Tanggal', 'type' => 'date', 'min' => now()->timezone('Asia/Jakarta')->format('Y-m-d')])
                        </div>
                    </div>
                    <div class="my-2">
                        @include('components.field.select', ['label' => 'components.field.label', 'title' => 'Lokasi Kota', 'data' => $cities])
                    </div>
                    <div class="my-2">
                        @include('components.field.text-area', ['label' => 'components.field.label', 'title' => 'Alamat Lengkap'])
                    </div>
                    <div class="my-2">
                        @include('components.field.input-text', ['label' => 'components.field.label', 'title' => 'Nama', 'value' => $user->name])
                    </div>
                    <div class="my-2">
                        @include('components.field.input-text', ['label' => 'components.field.label', 'title' => 'No. HP/WA', 'value' => $user->getPhoneNumber()])
                    </div>
                    <div class="my-2">
